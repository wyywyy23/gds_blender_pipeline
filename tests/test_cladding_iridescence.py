...
a.state.specs=[{key:'iridescence',label:'Film',group:'Appearance',stage:'preset',default:false},{key:'iridescence_strength',label:'Strength',group:'Appearance',stage:'preset',default:.85,min:0,max:1,step:.05}];
a.applyPreset({preset});
const inputs=a.ids.get('preset-options').querySelectorAll('input');
